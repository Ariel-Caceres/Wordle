...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    const words = [
      ...
      { name: "bread", language_id: 2, isCompleted: false, difficulty_id: 2 },
      { name: "tea", language_id: 2, isCompleted: false, difficulty_id: 1 },
      { name: "sea", language_id: 2, isCompleted: false, difficulty_id: 1 },
      { name: "voice", language_id: 2, isCompleted: false, difficulty_id: 2 },
      { name: "water", language_id: 2, isCompleted: false, difficulty_id: 2 },
      { name: "book", language_id: 2, isCompleted: false, difficulty_id: 2 },
      { name: "pen", language_id: 2, isCompleted: false, difficulty_id: 1 },
      { name: "key", language_id: 2, isCompleted: false, difficulty_id: 1 },
      ...
      { name: "fish", language_id: 2, isCompleted: false, difficulty_id: 2 },
      { name: "light", language_id: 2, isCompleted: false, difficulty_id: 2 },
      { name: "air", language_id: 2, isCompleted: false, difficulty_id: 1 },
